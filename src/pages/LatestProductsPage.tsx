...
import { LATEST_PRODUCTS } from '../data/products';
import { Product } from '../types';

const LatestProductsPage: React.FC = () => {
  const [filteredProducts, setFilteredProducts] = useState<Product[]>(LATEST_PRODUCTS);
  ...
  const handleResetFilters = (resetFilters: FilterState) => {
    ...
    setFilteredProducts(LATEST_PRODUCTS);
  };
      ...
      <div className="bg-gradient-to-br from-primary-600 to-primary-700 text-white py-20">
        <div className="container-custom">
          <div className="flex items-center mb-4">
            ...
            <h1 className="text-4xl font-bold">Latest Reviews</h1>
          </div>
          <p className="text-xl max-w-2xl text-primary-100">
            Stay up-to-date with our newest product reviews and recommendations.
          </p>
        </div>
      </div>
            ...
            <div className="mb-8 flex items-center justify-between">
              <div>
                ...
                <p className="text-gray-600">
                  Showing {filteredProducts.length} of {LATEST_PRODUCTS.length} latest reviews
                  {filtersActive && (
